...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'nested_scope_isolated_desc': 'This counter value is completely isolated from other stack levels.',
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) => BindingWidget(
            bindings: [
              Bind<BasicRxController>(() => BasicRxController()),
            ],
        ...
        GoRoute(
          ...
          builder: (context, state) {
            ...
            return BindingWidget(
              bindings: [
                Bind<NestedScopeController>(() => NestedScopeController(depth: depth)),
              ],
        ...
        GoRoute(
          ...
          builder: (context, state) => BindingWidget(
            bindings: [
              Bind<SelfHealingSafetyController>(() => SelfHealingSafetyController()),
            ],
        ...
        GoRoute(
          ...
          builder: (context, state) => BindingWidget(
            bindings: [
              Bind<ConcurrentUpdateController>(() => ConcurrentUpdateController()),
            ],
