...
import 'extra_settings_controller.dart';

class ExtraSettingsPage extends GetView<ExtraSettingsController> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildThemeCard(theme, isDark, primaryColor),
  ...
  Widget _buildThemeCard(ThemeData theme, bool isDark, Color primaryColor) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            final darkActive = controller.isDarkMode;
              ...
              title: Row(
                children: [
                  ...
                  Obx(
                    () => Text(
                      darkActive
                          ? 'settings_dark_active'.tr
                          : 'settings_light_active'.tr,
  ...
  Widget _buildLanguageCard(ThemeData theme, bool isDark, Color primaryColor) {
    final currentLanguageCode = controller.currentLanguageCode ?? 'ko';
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: InkWell(
                  onTap: () => controller.setLocale(const Locale('en', 'US')),
              ...
              Expanded(
                child: InkWell(
                  onTap: () => controller.setLocale(const Locale('ko', 'KR')),
                  borderRadius: BorderRadius.circular(12),
                  child: Container(
                    padding: const EdgeInsets.symmetric(vertical: 16),
                    decoration: BoxDecoration(
